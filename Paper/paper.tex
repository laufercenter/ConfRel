...
Second, we looked at a series of protein structure which has a similar sequence but different fold and function. We 
investigated whether confinement method can predict their conformational preferences.
Third, we looked at 6 target proteins from the CASP9 experiment~\cite{Moult2011}.  For each target, we examined up to 5 submitted
