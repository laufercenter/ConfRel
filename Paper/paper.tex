...
$\beta$ conformation are summarized in Figure S1 and S2-S7.
...
state, and our calculated free energy based ranking matches well with GDT-TS (Figure S8 in the supporting information).
...
relative to the experimental structure (Figure~\ref{fig:T0569_per_residue} and Figure S9). The side chains of these
...
the predicted model (Figure~\ref{fig:T0569_per_residue} and Figure S10). There is also a large difference around K76,
...
structure (Figure S11). Per-residue free energy calculations (not shown) show that despite only small variations at the
...
\begin{figure}
\begin{center}
\includegraphics[width=4.8in]{Target_538_compare.pdf}
\end{center}
\caption{Small differences in side-chain orientation can cause large differences in free energy. We compare the
    experimental structure and a computer generated model for CASP target T0538. Two salt bridges between residues
    E35-R32 and E28-K24 exist in the native structure. These are absent in the computer generated model structure.
    Instead, a new salt bridge is formed between residues R32-E28 in model. } 
