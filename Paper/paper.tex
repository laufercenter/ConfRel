...
Calculation of free energy have been successfully attempted by a number of groups \cite{Meirovitch2007}, 
...
\subsection{Confinement method produces correct results in control experiments}
...
\begin{table}
\begin{center}
\caption{Confinement method assigns a more favorable free energy to the experimentally
...
\subsection{Confinement method correctly predicts the structural preferences of chameleon
sequences}
